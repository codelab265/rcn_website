...
function Partnership() {
    return (
        <MainLayout>
            ...
            <section className="container pt-[100px] md:pt-[200px] pb-[60px] md:pb-[104px] bg-[#2838ce] relative">
                ...
                <div className="text-[#5564ea] text-[60px] sm:text-[120px] md:text-[160px] lg:text-[200px] font-normal font-abhaya leading-[80px] sm:leading-[120px] md:leading-[140px] lg:leading-[160px] text-center">
                    Our Mission
                </div>
                ...
                <div className="w-full max-w-[1080px] mx-auto">
                    <div className="w-[90%] sm:w-[600px] md:w-[700px] lg:w-[619px] text-white text-sm sm:text-base font-normal font-inter leading-normal mt-[30px] md:mt-[52px]">
                        ...
                        join hands with us in this sacred mission. With a wide
                        range of ongoing projects, both within and beyond the
                        church, we are strategically building a storehouse of
                        resources to meet the day-to-day demands of this great
                        work.
                        <br />
                        <br />
                        As we walk side by side with the Master, we recognize
                        the importance of creating a platform that accommodates
                        the many aspects of our ministry—both in-reach and
                        outreach. This initiative allows partners to contribute
                        their time, skills, and financial resources to support
                        the ministry’s growth and impact.
                    </div>
                </div>
            ...
            <section className="container pt-[100px] md:pt-[150px] pb-[60px] md:pb-[107px]">
            ...
            <section className="container pt-[60px] md:pt-[103px] pb-[60px] md:pb-[116px] flex flex-col lg:flex-row space-y-[40px] lg:space-y-0 lg:space-x-[72px] bg-[#ce2c28]/5 relative">
                ...
                <div className="w-full lg:w-auto pt-[30px] md:pt-[46px]">
                    <div className="w-full lg:w-[619px] text-black text-sm sm:text-base font-normal font-inter leading-relaxed">
                        RCN Remnant Kingdom Stewards (RKS) is a global network
                        of believers committed to the Biblical principles of
                        righteous living. Our goal is to connect with the
                        dedicated pillars of the ministry, provide a
                        comprehensive reporting system, and reinforce the
                        ministry’s objectives.
                        <br />
                        <br />
                        Through this platform, we foster a framework for various
                        forms of financial engagement, strengthening the
                        covenant relationship we share, as outlined in 2
                        Corinthians 9:6-14. The early church demonstrated such
                        unity in Acts 4:32, which amplified the Apostles' power
                        in Acts 4:33 and ensured that no one among them lacked,
                        as seen in Acts 4:34.
                        <br />
                        <br />
                        Our committee members are individuals within the
                        ministry who share the vision of the Set Man, committed
                        to actualizing the Lord’s mandate to build a strong
                        Apostolic Christian Community.
                    </div>
                </div>

                <div className="text-[#dddddd] text-[120px] sm:text-[200px] md:text-[250px] font-normal font-abhaya leading-[120px] sm:leading-[180px] md:leading-[200px] absolute right-[20px] sm:right-[50px] md:right-[88px] bottom-[20px] md:bottom-[144px] hidden lg:flex">
                    Stewards
                </div>
            </section>

            <section className="container pt-[60px] md:pt-[95px] pb-[80px] md:pb-[156px]">
                ...
                <div className="max-w-[1080px] w-full mx-auto mt-8 flex flex-col-reverse md:flex-row gap-[30px] md:gap-[43px]">
                    <div className="w-full md:max-w-[546px] flex flex-col gap-[20px] md:gap-[30px]">
                        <div className="text-black text-xl md:text-[28px] lg:text-[32px] font-bold font-['Abhaya Libre'] leading-[28px] md:leading-[34px] lg:leading-[38.40px]">
                            Becoming an RKS Partner requires a sacrificial
                            commitment, beginning with a consecrated lifestyle
                            dedicated to God.
                        </div>

                        <div className="text-black text-sm md:text-base font-normal font-inter leading-relaxed md:leading-normal">
                            Every act of generosity should stem from a place of
                            righteous and honest living. Each partner must be
                            intentional and Spirit-led in their contributions.
                            We are committed to supporting the mandate given to
                            Apostle Arome Osayi by uplifting him and the
                            ministry in prayer, so that God's work may
                            continually advance.
                            <br />
                            <br />
                            We welcome your volunteered time and skills to meet
                            the ministry’s in-house needs, along with periodic
                            financial support as each partner is able to give. A
                            robust line of communication will be maintained with
                            every partner, ensuring you receive timely
                            notifications about our events, outreaches, and
                            ministry progress.
                        </div>
